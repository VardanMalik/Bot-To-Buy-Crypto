    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        timelineResponse[0].entries.map((x) => {
            ...
            try { // Used try catch because pstman api schema was not same for every tweet in case of .tweetReasult and was giving error
                tweets.push({
                    contents: (_a = x.content.content.tweetResult.result.legacy.full_text) !== null && _a !== void 0 ? _a : x.content.content.tweetResult.result.core.user_result.result.legacy.description, //Tweet
